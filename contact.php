                ...
                <div class="contact-us">
                    <h1>Contact</h1>
                        ...
                        <form action="" method="post" class="message">
                            <input type="text" name="name" placeholder="Name" onFocus="this.select();" onMouseOut="javascript:return false;" /><br>
                            <input type="text" name="email" placeholder="Email" onFocus="this.select();" onMouseOut="javascript:return false;" /><br>
                            <input type="text" name="subject" placeholder="Subject" onFocus="this.select();" onMouseOut="javascript:return false;" /><br>
